...
class MessageProducerTest {
    ...
    private fun messageField(field: String, json: String): String {
        ...
        val messageOne = messageProducer.produceMessage(jsonObjectOne, id, false, false, dateValue, "_lastModifiedDateTime", false, false, false, false, false, encryptionResult, dataKeyResult, database, collection)
