...
data class DecryptedStream(val inputStream: InputStream, val fileName: String, val cipher: Cipher)
data class DecompressedStream(val inputStream: InputStream, val fileName: String, val cipher: Cipher)
