...
class UCHistoricDataImporterSpec : FunSpec() {
    ...
    init {
        ...
        test("Should match  manifest file count, content  generated in S3") {
            ...
            |"{""someId"":""RANDOM_GUID"",""declarationId"":""database-1.collection-2.0001-1"",""createdDateTime"":""2010-01-01T00:00:00.000+0000""}"|1543676462009|database-1|collection-2|IMPORT|HDI|"{""someId"":""RANDOM_GUID"",""declarationId"":""database-1.collection-2.0001-1"",""createdDateTime"":""2010-01-01T00:00:00.000Z""}"|MONGO_IMPORT
            ...
            |"{""someId"":""RANDOM_GUID"",""declarationId"":""database-1.collection-2.0002-1"",""createdDateTime"":""2010-01-01T00:00:00.000+0000""}"|1543676462009|database-1|collection-2|IMPORT|HDI|"{""someId"":""RANDOM_GUID"",""declarationId"":""database-1.collection-2.0002-1"",""createdDateTime"":""2010-01-01T00:00:00.000Z""}"|MONGO_IMPORT
            ...
            |"{""someId"":""RANDOM_GUID"",""declarationId"":""database-2.collection-3.0001-1"",""createdDateTime"":""2010-01-01T00:00:00.000+0000""}"|1543676462009|database-2|collection-3|IMPORT|HDI|"{""someId"":""RANDOM_GUID"",""declarationId"":""database-2.collection-3.0001-1"",""createdDateTime"":""2010-01-01T00:00:00.000Z""}"|MONGO_IMPORT
